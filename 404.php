	...
	<main id="primary" class="site-main">
		...
		<section class="error-404 not-found">
			...
			<div class="page-content">
				<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'artemis2021' ); ?></p>
					...
					<div class="widget widget_categories">
						<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'artemis2021' ); ?></h2>
						<ul>
							<?php
							wp_list_categories(
								array(
